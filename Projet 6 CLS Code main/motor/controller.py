...
import time
from motor.config import (DEFAULT_SPEED_RPM, DEFAULT_STEPS_PER_REV, DEFAULT_MICROSTEP,
...
class DualMotorController:
    ...
    def rotate_both(self, angle1, angle2):
        """Fait tourner les deux moteurs d'angles différents"""
        print(f"Rotation moteur1: {angle1}° | moteur2: {angle2}°")
