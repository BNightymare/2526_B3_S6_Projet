import smbus2
import time
from imu.setting import (
    i2cbus, LSM6DSOX_ADDR, bytes,
    FQ104HZ, FS_2G, FQ_G_104HZ, FS_G_245DPS,
...
class drv_lsm6dsow:
    def __init__(self, bus=1 , adresse=0x6A):
    ...
    def close(self):
        """Ferme proprement la connexion I2C"""
        self.bus.close()
